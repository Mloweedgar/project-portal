...
@section('content')
        ...
        <div class="row content-row toggleable-wrapper">
            <div class="col-md-12">
                <div class="card dynamic-card toggleable-container">
                    <div class="header card-header-static toggleable-card">
                        <h2>
                            {{trans('project.description-asset')}}
                            @component('back.components.individual-visibility', [
                                'project' => $project->id,
                                'section' => 'i',
    ...
    -->
    @if (Auth::user()->isAdmin() || $project_information->description_services_private)
        <div class="row content-row toggleable-wrapper">
            <div class="col-md-12">
                <div class="card dynamic-card toggleable-container">
                    <div class="header card-header-static toggleable-card">
                        <h2>
                            ...
                            @component('back.components.individual-visibility', [
                                ...
                                'status' => $project_information->description_services_private,
                                'route' => route('project.project-informationIndividualVisibility')
                            ])@endcomponent
                        </h2>
                    </div>
    ...
    -->
    @if (Auth::user()->isAdmin() || $project_information->reasons_ppp_private)
        <div class="row content-row toggleable-wrapper">
            <div class="col-md-12">
                <div class="card dynamic-card toggleable-container">
                    <div class="header card-header-static toggleable-card">
                        <h2>
                            ...
                            @component('back.components.individual-visibility', [
                                ...
                                'status' => $project_information->reasons_ppp_private,
                                'route' => route('project.project-informationIndividualVisibility')
                            ])@endcomponent
                        </h2>
                    </div>
    ...
    -->
    @if (Auth::user()->isAdmin() || $project_information->stakeholder_consultation_private)
        <div class="row content-row toggleable-wrapper">
            <div class="col-md-12">
                <div class="card dynamic-card toggleable-container">
                    <div class="header card-header-static toggleable-card">
                        <h2>
                            ...
                            @component('back.components.individual-visibility', [
                                ...
                                'status' => $project_information->stakeholder_consultation_private,
                                'route' => route('project.project-informationIndividualVisibility')
                            ])@endcomponent
                        </h2>
                    </div>
