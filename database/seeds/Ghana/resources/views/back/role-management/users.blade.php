                ...
                <div class="table-responsive">
                  <table class="table table-modal w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="td-projects-section-gray w-50" data-parent="12">
                              <input type="checkbox" id="sectorid23" class="filled-in subSection" value="23" name="sections[]" data-parent="12">
                              <label for="sectorid23">{{trans('project.section.project_details.environment_social_impact_assessment')}}</label>
                            </td>
                    ...
                    <tbody>
                      ...
                      <tr>
                          <td class="td-projects-section-gray w-50" data-parent="12">
                            ...
                            <label for="sectoridEdit23">{{trans('project.section.project_details.environment_social_impact_assessment')}}</label>
                          </td>
