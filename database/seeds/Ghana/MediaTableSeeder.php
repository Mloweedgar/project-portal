...
class MediaTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Sliders
        DB::table('media')->insert(['name'=>"1", "old_name"=>"1", "extension"=>"jpeg", "mime_type"=>"image/jpeg", "section" => "s", "position" => 1, "path" => "/img/samples/slider/1.jpg", "created_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s'), "updated_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s')]);
        DB::table('media')->insert(['name'=>"2", "old_name"=>"2", "extension"=>"jpeg", "mime_type"=>"image/jpeg", "section" => "s", "position" => 2, "path" => "/img/samples/slider/2.jpg", "created_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s'), "updated_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s')]);
        DB::table('media')->insert(['name'=>"3", "old_name"=>"3", "extension"=>"jpeg", "mime_type"=>"image/jpeg", "section" => "s", "position" => 3, "path" => "/img/samples/slider/3.jpg", "created_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s'), "updated_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s')]);

        // Entities media
        DB::table('media')->insert(['name'=>"finance", "old_name"=>"finance.png", "extension"=>"png", "mime_type"=>"image/png", "section" => "par", "position" => 1, "path" => "/img/logo.png", "created_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s'), "updated_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s')]);
        DB::table('media')->insert(['name'=>"energy", "old_name"=>"energy.png", "extension"=>"png", "mime_type"=>"image/png", "section" => "par", "position" => 2, "path" => "/img/parties/energy.png", "created_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s'), "updated_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s')]);
        DB::table('media')->insert(['name'=>"transport", "old_name"=>"transport.png", "extension"=>"png", "mime_type"=>"image/png", "section" => "par", "position" => 3, "path" => "/img/parties/transport.png", "created_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s'), "updated_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s')]);
        DB::table('media')->insert(['name'=>"industrial", "old_name"=>"industrial.jpg", "extension"=>"jpeg", "mime_type"=>"image/jpeg", "section" => "par", "position" => 4, "path" => "/img/parties/industrial.jpg", "created_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s'), "updated_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s')]);
        DB::table('media')->insert(['name'=>"telecom", "old_name"=>"telecom.png", "extension"=>"png", "mime_type"=>"image/png", "section" => "par", "position" => 5, "path" => "/img/parties/telecom.png", "created_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s'), "updated_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s')]);
        DB::table('media')->insert(['name'=>"water", "old_name"=>"water.jpg", "extension"=>"jpeg", "mime_type"=>"image/jpeg", "section" => "par", "position" => 6, "path" => "/img/parties/water.jpg", "created_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s'), "updated_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s')]);
        DB::table('media')->insert(['name'=>"pppunit", "old_name"=>"pppunit.png", "extension"=>"png", "mime_type"=>"image/png", "section" => "par", "position" => 7, "path" => "/img/parties/pppunit.png", "created_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s'), "updated_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s')]);
