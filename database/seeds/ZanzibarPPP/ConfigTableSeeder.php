...
class ConfigTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('configs')->insert(['name'=>"aboutppp", "value"=>"About Zanzibar PPP.", "created_at"=>$now, "updated_at"=>$now]);
        DB::table('configs')->insert(['name'=>"homepage", "value"=>"http://18.130.140.195/", "created_at"=>$now, "updated_at"=>$now]);
        ...
        DB::table('configs')->insert(['name'=>"institution", "value"=>"Zanzibar PPP", "created_at"=>$now, "updated_at"=>$now]);
