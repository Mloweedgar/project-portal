...
class CreateProjectInformationTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('project_information', function (Blueprint $table) {
            ...
            $table->text('project_summary_document')->nullable();
            $table->boolean('project_summary_document_private')->default(1);
            ...
            $table->string('indicative_timing_invest', 50)->nullable();
            $table->boolean('indicative_timing_invest_private')->default(1);
            $table->integer('ppp_delivery_model_id')->unsigned()->index();
            $table->timestamps();
        });
    }
