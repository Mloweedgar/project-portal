...
class ProjectInformationController extends ProjectBaseController
{
    ...
    public function index($id)
    {
        ...
        return view('back.project.project-information',compact('currency','sectors','regions','stages', 'sponsors', 'project', 'exists', 'project_information', 'currencies','ocid', 'hasCoordinators', 'cofog','indicative_timing_invests'));
    }
