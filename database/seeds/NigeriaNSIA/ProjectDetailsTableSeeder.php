...
class ProjectDetailsTableSeeder extends Seeder
{
    ...
    public function run()
    {
         ...
         * Contract Summary
         */
        DB::table('pd_contract_summary')->insert([
            'name' => 'Nature of NSIA’s investment (equity, loan, guarantee)',
        ...
        DB::table('pd_contract_summary')->insert([
            'name' => 'Technical description of the infrastructure to be developed',
            'description' => 'Lorem ipsum dolor sit amet, ne eam dicat nostrum. Ad zril principes vim, nec etiam alienum in, eos molestie facilisis interesset at. Magna iracundia inciderint cum ut, at vis suscipit nominati efficiendi. Id intellegat inciderint usu, ea unum dicta scripta has, aeque dissentiet per id. Vel no feugiat graecis. Est purto dissentias ea.',
            'project_details_id' => 1,
            'position' => 3,
        ]);
        DB::table('pd_contract_summary')->insert([
            'name' => 'Status/dates of various approvals',
            'description' => 'Lorem ipsum dolor sit amet, ne eam dicat nostrum. Ad zril principes vim, nec etiam alienum in, eos molestie facilisis interesset at. Magna iracundia inciderint cum ut, at vis suscipit nominati efficiendi. Id intellegat inciderint usu, ea unum dicta scripta has, aeque dissentiet per id. Vel no feugiat graecis. Est purto dissentias ea.',
            'project_details_id' => 1,
            'position' => 4,
        ]);
        DB::table('pd_contract_summary')->insert([
            'name' => 'High-level description of the proposed services',
            'description' => 'Lorem ipsum dolor sit amet, ne eam dicat nostrum. Ad zril principes vim, nec etiam alienum in, eos molestie facilisis interesset at. Magna iracundia inciderint cum ut, at vis suscipit nominati efficiendi. Id intellegat inciderint usu, ea unum dicta scripta has, aeque dissentiet per id. Vel no feugiat graecis. Est purto dissentias ea.',
            'project_details_id' => 1,
            'position' => 5,
        ]);
        DB::table('pd_contract_summary')->insert([
            'name' => 'Estimated demand to be served annually',
            'description' => 'Lorem ipsum dolor sit amet, ne eam dicat nostrum. Ad zril principes vim, nec etiam alienum in, eos molestie facilisis interesset at. Magna iracundia inciderint cum ut, at vis suscipit nominati efficiendi. Id intellegat inciderint usu, ea unum dicta scripta has, aeque dissentiet per id. Vel no feugiat graecis. Est purto dissentias ea.',
            'project_details_id' => 1,
            'position' => 6,
        ]);
        DB::table('pd_contract_summary')->insert([
            'name' => 'Project additionality',
            'description' => 'Lorem ipsum dolor sit amet, ne eam dicat nostrum. Ad zril principes vim, nec etiam alienum in, eos molestie facilisis interesset at. Magna iracundia inciderint cum ut, at vis suscipit nominati efficiendi. Id intellegat inciderint usu, ea unum dicta scripta has, aeque dissentiet per id. Vel no feugiat graecis. Est purto dissentias ea.',
            'project_details_id' => 1,
            'position' => 7,
        ]);
        ...
        DB::table('pd_financial')->insert([
            'name' => 'Shareholders of project vehicle',
            'description' => 'Lorem ipsum dolor sit amet, ne eam dicat nostrum. Ad zril principes vim, nec etiam alienum in, eos molestie facilisis interesset at.',
            'project_details_id' => 1,
            'position' => 2,
        ]);
        DB::table('pd_financial')->insert([
            'name' => 'Share capital of project vehicle',
            'description' => 'Lorem ipsum dolor sit amet, ne eam dicat nostrum. Ad zril principes vim, nec etiam alienum in, eos molestie facilisis interesset at.',
            'project_details_id' => 1,
            'position' => 3,
        ]);
        DB::table('pd_financial')->insert([
            'name' => 'Shareholders categories senior debt, mezzanine debt, other',
            'description' => 'Lorem ipsum dolor sit amet, ne eam dicat nostrum. Ad zril principes vim, nec etiam alienum in, eos molestie facilisis interesset at.',
            'project_details_id' => 1,
            'position' => 4,
        ]);
        DB::table('pd_financial')->insert([
            'name' => 'Amount and tenor of each, fixed or floating rate',
            'description' => 'Lorem ipsum dolor sit amet, ne eam dicat nostrum. Ad zril principes vim, nec etiam alienum in, eos molestie facilisis interesset at.',
            'project_details_id' => 1,
            'position' => 5,
        ]);
