        ...
        <div class="container">
            <ul class="docs-nav" id="menu-left">
                ...
                @if (!Auth::user()->isIT() && !Auth::user()->isAuditor())
                    ...
                    @endif
                    <li><a href="#project_basic_info" class=" ">Project basic information - NSIA to Public</a></li>
                    <li><a href="#project_basic_info_private" class=" ">Project basic information - NSIA to Private</a></li>
                    <li><a href="#project_basic_info_project" class=" ">Project basic information - NSIA to Projects</a></li>
                    ...
                    <li><a href="#parties" class=" ">Parties</a></li>
                        <li><a href="#contract_summary" class=" ">Contract summary</a></li>
                        <li><a href="#redacted_ppp_agreement" class=" ">Redacted PPP Agreement</a></li>
                        <li><a href="#financial_structure" class=" ">Financial information</a></li>
                    <li><a href="#risks" class=" ">Risks</a></li>
                    <li><a href="#government_support" class=" ">Government support / Guarantees</a></li>
            ...
            <div class="docs-content">
                ...
                @if (!Auth::user()->isIT() && !Auth::user()->isAuditor())
                    ...
                    <h3 id="project_basic_info"> Project basic information - NSIA to Public</h3>
                    <p>This page of the backend allows the user to manage the basic information of the project.</p>
                    <img src="/img/documentation/{{env('APP_NAME')}}/basicinfo1_public.jpg" class="responsive-img" />
                    ...
                    <h3 id="project_basic_info_private"> Project basic information - NSIA to Private</h3>
                    <p>This page of the backend allows the user to manage the basic information of the project.</p>
                    <img src="/img/documentation/{{env('APP_NAME')}}/basicinfo1_private.jpg" class="responsive-img" />
                    <p>The user can see two types of sections on this page:</p>
                    <h4>Main information section</h4>
                    <p>In this section, the user selects the essential information of the project.</p>
                    <h4>Main information, sector</h4>
                    ...
                    <img src="/img/documentation/{{env('APP_NAME')}}/region.jpg" class="responsive-img" />
                    <h4>Main information, phase</h4>
                    <p>The user cannot select the phase of the project. The phase of the project will be Private Development.</p>
                    <img src="/img/documentation/{{env('APP_NAME')}}/phase_private.jpg" class="responsive-img" />
                    <h4>Main information, sponsoring agency</h4>
                    <p>The user can select the sponsoring agency of the project. Only one sponsoring agency can be selected.</p>
                    <img src="/img/documentation/{{env('APP_NAME')}}/sponsoring.jpg" class="responsive-img" />
                    <h4>Main information, project value</h4>
                    ...
                    <h3 id="project_basic_info_project"> Project basic information - NSIA to Projects</h3>
                    <p>This page of the backend allows the user to manage the basic information of the project.</p>
                    <img src="/img/documentation/{{env('APP_NAME')}}/basicinfo1_projects.jpg" class="responsive-img" />
                    <p>The user can see two types of sections on this page:</p>
                    <h4>Main information section</h4>
                    <p>In this section, the user selects the essential information of the project.</p>
                    <h4>Main information, sector</h4>
                    ...
                    <h4>NSIA to Public</h4>
                    <img src="/img/documentation/{{env('APP_NAME')}}/parties_public.jpg" class="responsive-img" />
                    <h4>NSIA to Private</h4>
                    <img src="/img/documentation/{{env('APP_NAME')}}/parties_private.jpg" class="responsive-img" />
                    <h4>NSIA PPP Projects</h4>
                    <img src="/img/documentation/{{env('APP_NAME')}}/parties_projects.jpg" class="responsive-img" />

                    <p>Depending on the type of project, the user can find three different sections on this page:</p>
                    <h4>Add party</h4>
                    ...
                    <h3 id="contract_summary"> Contract Summary</h3>
                    <p>This page allows the user to add and manage the summary of the contract.</p>
                    <img src="/img/documentation/{{env('APP_NAME')}}/contractsummary1.jpg" class="responsive-img" />
                    <p>There are two sections available on this page:</p>
                    <h4>Add contract summary</h4>
                    <p>In this section, the user can add a Summary of the contract by clicking on “Add contract summary”.</p>
                    <p>After clicking the button, a new form will appear with three fields:</p>
                    <ul>
                        <li>The “Contract Summary name” field where the user can add a “Name” for the summary to be added. (This field is required)</li>
                        <li>The “Description” field where the user can add a short description for the contract summary. (This field is required)</li>
                        <li>The file upload field where the user can upload a file or multiple files by clicking on the “Add” button or by “Drag & Drop” the files. (Optional field)</li>
                    </ul>
                    <p>When all the required fields are filled, the user can save all the information by clicking on the “Publish” button.</p>
                    <img src="/img/documentation/{{env('APP_NAME')}}/contractsummary2.jpg" class="responsive-img" />
                    <h4>Existing contract summary</h4>
                    <p>In this section, the user can click to edit the information of a Contract Summary or to delete it.</p>
                    <img src="/img/documentation/{{env('APP_NAME')}}/contractsummary3.jpg" class="responsive-img" />
                    <ul>
                        <li>To edit a “Contract Summary”, the user must fill the changes and click on the “Publish” button.</li>
                        <li>To delete a “Contract Summary”, the user must click on the delete button on the header of the contract summary box.</li>
                    </ul>

                    <h3 id="redacted_ppp_agreement"> Redacted PPP Agreement</h3>
                    <p>This page allows the user to add and manage the project Redacted PPP Agreement.</p>
                    <img src="/img/documentation/{{env('APP_NAME')}}/pppagreement.jpg" class="responsive-img" />
                    <p>There are two sections available on this page:</p>
                    <h4>Add redacted ppp agreement</h4>
                    <p>In this section, the user can add a Redacted PPP Agreement by clicking on “Add group of documents”.</p>
                    <p>After clicking the button, a new form will appear with three fields:</p>
                    <ul>
                    ...
                    <p>When all the required fields are filled, the user can save all the information by clicking on the “Publish” button.</p>
                    <h4>Existing redacted ppp agreement</h4>
                    <p>In this section, the user can click to edit the information of a Redacted PPP Agreement or to delete it.</p>
                    <img src="/img/documentation/{{env('APP_NAME')}}/pppagreement2.jpg" class="responsive-img" />
                    <ul>
                        <li>To edit a “Redacted PPP Agreement”, the user must fill the changes and click on the “Publish” button.</li>
                        <li>To delete a “Redacted PPP Agreement”, the user must click on the delete button on the header of the redacted PPP agreement box.</li>
                    </ul>
                    <div class="video-wrapper">
                        <div class="youtube" data-embed="imjzDtTfahs">
                            <div class="play-button"></div>
                        </div>
                    </div>

                    <h3 id="financial_structure"> Financial Information</h3>
                    <p>This page allows the user to add and manage the project Financial Information.</p>
                    <img src="/img/documentation/{{env('APP_NAME')}}/financialinformation1.jpg" class="responsive-img" />
                    <p>There are three sections available on this page:</p>
                    <h4>Add financial information</h4>
                    <p>In this section, the user can add a Financial Information by clicking on “Add financial” button.</p>
                    <p>After clicking the button, a new form will appear with three fields:</p>
                    <ul>
                        <li>The “Financial name” field where the user can add a “Name” for the financial information to be added. (This field is required)</li>
                        <li>The “Description” field where the user can add a short description for the financial information. (This field is required)</li>
                        <li>The file upload field where the user can upload a file or multiple files by clicking on the “Add” button or by “Drag & Drop” the files. (Optional field)</li>
                    </ul>
                    <p>When all the required fields are filled, the user can save all the information by clicking on the “Publish” button.</p>
                    <img src="/img/documentation/{{env('APP_NAME')}}/financialinformation2.jpg" class="responsive-img" />
                    <h4>Existing financial information</h4>
                    <p>In this section, the user can click to edit the information of a financial information or to delete it.</p>
                    <img src="/img/documentation/{{env('APP_NAME')}}/financialinformation3.jpg" class="responsive-img" />
                    <ul>
                        <li>To edit “Financial Information”, the user must fill all the required fields with the changes to be uploaded and click on the “Publish” button.</li>
                        <li>To delete a “Financial information”, the user must click on the delete button on the header of the financial information box.</li>
                    </ul>
                    <h4>Financial summary</h4>
                    <p>In this section, the user will be able to see all the information previously filled in the “Financial Information” section as a table.</p>
                    <img src="/img/documentation/{{env('APP_NAME')}}/financialinformation4.jpg" class="responsive-img" />
                    ...
                    <h3 id="government_support"> Government Support / Guarantee - commitments received</h3>
                    <p>This page allows the user to add and manage the project Government Support (NSIA to Public) or Guarantees – commitments received (NSIA to Projects). </p>
                    <img src="/img/documentation/{{env('APP_NAME')}}/gov.jpg" class="responsive-img" />
                    <p>The user can find two sections on this page:</p>
                    <h4>Add Government Support / Guarantees – commitments received</h4>
                    <p>In this section, the user can click to display the information to be filled to add a new Government Support or Guarantees – commitments received.</p>
                    <p>After clicking the button, a new form will appear with four fields:</p>
                    <ul>
                        <li>The “name” field where the user can add a “Name” for the Government Support / Guarantee  to be added. (This field is required)</li>
                        <li>The “description” field where the user can add a “Description” for the Government Support / Guarantee  to be added. (This field is required)</li>
                    ...
                    <h4>Existing Government Support / Guarantee – commitments received</h4>
                    <p>In this section, the user can click to edit the information of a Government Support / Guarantee or delete it.</p>
                    <ul>
                        <li>To edit a Government Support / Guarantee, the user must fill the changes and click on the “Publish” button</li>
                        <li>To delete a Government Support / Guarantee, the user must click on the delete button on the header of the box</li>
                    </ul>
                ...
                @if (Auth::user()->isAdmin())
                    ...
                    <ul>
                        <li>The user must select to send the notification to the users with specific roles, to specific users or to specific project users:</li>
                ...
                @if (!Auth::user()->isIT() && !Auth::user()->isAuditor())
                    ...
                    <p>First, the Project Coordinator attached to that project will receive a confirmation email for the Request for Modification and a new task will be generated.</p>
                    ...
                    @if (!Auth::user()->isDataEntry() && !Auth::user()->isProjectCoordinator())
                        ...
                        <p>After creating a task, there is a two-process confirmation where both the Project Coordinator and Administrator are involved.</p>
                        <p>First, a Project Coordinator have to confirm or decline the task created by the Data Entry, and finally the Administration have to accept or decline the task in order to make it public at the website or not.</p>
                        <p>For the Project Coordinator to confirm or decline a task, have to perform the action desired at the Task Management section of the backend and click at the green button for confirmation or red button for declining the task.</p>
                        <img src="/img/documentation/{{env('APP_NAME')}}/task5.jpg" class="responsive-img" />
                        <p>Once the Project Coordinator confirms the task, the Administrator will be able to approve it and make the modifications public.</p>
                        <p>The Project Coordinator will see the task under the state “Waiting for Approval”:</p>
                        <img src="/img/documentation/{{env('APP_NAME')}}/task6.jpg" class="responsive-img" />
                        <p>Now is time for the Administrator to approve the task that the Project Coordinator just sent to the Administrator.</p>
                        <p>In addition, by clicking at the blue button, is it possible to check what the changes are.</p>
                        ...
                        <div class="video-wrapper">
                            <div class="youtube" data-embed="2L5e7fY2mos">
                                <div class="play-button"></div>
                            </div>
                        </div>
                ...
                @if (!Auth::user()->isAuditor() && !Auth::user()->isIT() && !Auth::user()->isViewOnly())
                    ...
                    <ul>
                        ...
                        <li>Risks</li>
                        <li>Government support / Guarantee - commitments received</li>
                        <li>Tariffs</li>
