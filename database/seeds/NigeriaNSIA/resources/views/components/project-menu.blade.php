...
<div class="project-submenu">
    <ul>
        @if (Request::is('project/*/contract-information/*'))
             @if (Auth::user()->canAccessPDContractSummary($project))
                <li class="{{active('project/*/contract-information/contract-summary')}}"><a href="{{route('project-details-contract-summary', array('id' => $project->id))}}">{{__("project.section.project_details.contract-summary")}}</a></li>
            @endif
            ...
            @if (Auth::user()->canAccessPDFinancialSupport($project))
                <li class="{{active('project/*/contract-information/financial')}}"><a href="{{route('project-details-financial', array('id' => $project->id))}}">
            ...
            @if (Auth::user()->canAccessPDGovernmentSupport($project))
                <li class="{{active('project/*/contract-information/government-support')}}"><a href="{{route('project-details-government-support', array('id' => $project->id))}}">@if(isNigeriaSovereign() && !$project->isTypePublic()) {{__("project.section.project_details.government-support_ppp")}} @else {{__("project.section.project_details.government-support")}} @endif</a></li>
            @endif
