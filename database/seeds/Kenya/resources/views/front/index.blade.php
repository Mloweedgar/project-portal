...
@section('content')
    ...
    <div class="section-fluid-wrapper no-margin">
    ...
    <div id="searching-area" class="row">
        <div class="col-md-3">
            <div data-open-first="true" class="accordion">
                ...
                <div class="accordion-item" data-status="1">
                ...
                <div class="accordion-item filter_menu_button" data-status="0">
                    <div class="accordion-title"><h4>{{__('frontpage.filtercountry')}}<span id="regions-filter-counter" class="label label-primary hidden">3</span></h4></div>
                    <div class="accordion-content">
                        <ul>
...
@section('scripts')
    ...
    <script src="https://code.highcharts.com/mapdata/countries/{{ $country_code }}/{{ $country_code }}-all.js"></script>
                    ...
                    var map = Highcharts.mapChart('map', {
                        ...
                        colorAxis: {
                            dataClasses: [
                                ...
                                {
                                    to:'{{ $mapColor["To"] }}',
                                    @if (isset($mapColor['From'])) from:'{{$mapColor["From"]}}', @endif
                        ...
                        tooltip: {
                            formatter: function () {
                                return 'Projects in ' + this.point.code + ': <strong>' + this.point.value + '</strong>';
                            }
                        },
                        series: [{
                            cursor: 'normal',
                            data: [
                                @foreach($regions as $region)
                                    {"code":"{!! $region->name !!}","value":"{{ $region->num_projects }}"},
                                @endforeach
                            ],
                            mapData: geojson,
                            joinBy: ['COUNTY', 'code'],
                                ...
                                point:{
                                    events:{
                                        click: function(){
                                            ...
                                            var correlatedElement = document.getElementById("region-locator-"+this.index);
