        ...
        <div class="container">
            ...
            <div class="docs-content">
                ...
                @if (!Auth::user()->isIT() && !Auth::user()->isAuditor())
                    ...
                    <p>In this section, the user can add a new blank project to the database. A popup appears when the “Add project” is clicked to enter the project required information:</p>
                    <img src="/img/documentation/{{env('APP_NAME')}}/project2.jpg" class="responsive-img" />
                    <p>If the user clicks the “Save” button of the popup, the new project will be created and the page will redirect to the new project “Basic Project Information” page.</p>
                    <div class="video-wrapper">
                    ...
                    <h4>Main information, province</h4>
                    <p>The user can select the province of the project. Multi selection is available.</p>
                    ...
                    <h4>Main information, contracting authority</h4>
                    <p>The user can select the contracting authority of the project. Only one contracting authority can be selected.</p>
                ...
                @if (!Auth::user()->isAuditor() && !Auth::user()->isIT() && !Auth::user()->isViewOnly())
                    ...
                    <p>The application has a built-in drag and drop functionality to allow the possibility to change the project elements position. This functionality is available at the following sections:</p>
                    <ul>
