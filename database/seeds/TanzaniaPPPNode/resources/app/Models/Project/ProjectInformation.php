...
class ProjectInformation extends Model
{
    ...
    protected $fillable = ['project_id','sponsor_id','ocid','stage_id','project_need','description_services','reasons_ppp','stakeholder_consultation','description_asset','project_summary_document','project_value_usd','project_value_second'];

    protected static $logAttributes = ['project_id','sponsor_id','ocid','stage_id','project_need','description_services','reasons_ppp','stakeholder_consultation','description_asset','project_summary_document','project_value_usd','project_value_second'];
