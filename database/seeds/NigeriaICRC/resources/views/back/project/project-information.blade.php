...
@section('content')
    ...
    -->
    @if (Auth::user()->isAdmin() || json_decode($project_information)->project_summary_document_private)
        <div class="row content-row toggleable-wrapper">
            <div class="col-md-12">
                <div class="card dynamic-card toggleable-container">
                    <div class="header card-header-static toggleable-card">
                    ...
                    <div class="body not-visible" data-status="0">
                        <form method="post" class="frmEditDocument" action="{{route("project.project-information.edit")}}">
                            ...
                            <div class="form-group">
                                <b>{{__("project/project-details/documents.description")}}</b>
                                <div class="form-line">
                                    <textarea rows="5" class="form-control no-resize rich-editor" name="description" placeholder="{{trans('project/project-information.project_summary_document')}}">{{json_decode($project_information)->project_summary_document}}</textarea>
                                </div>
                            </div>
                            ...
                            <input type="hidden" name="submit-type">
                            @component('back.components.project-buttons',['section_fields' => ['project_id','position_table','description'],'position'=>7,'section'=>'i','project'=>$project->id,'hasCoordinators'=>$hasCoordinators])
                            @endcomponent
                        </form>
                    </div>
                </div>
