                                            ...
                                            <div class="panel-group wrap" id="accordion" role="tablist" aria-multiselectable="true">
                                                <div class="panel">
                                                    ...
                                                    <div id="collapsectOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingctOne">
                                                        <div class="panel-body">
                                                            @if($project->projectDetails->contractTerminations && count($project->projectDetails->contractTerminations->where('published', true)->where('party_type', 'concessionaire')) > 0)
                                                                <div class="table-responsive">
                                                                    <table class="table-type2">
                                                                        <thead>
                                                                        <tr>
