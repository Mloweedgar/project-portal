...
class MediaTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Sliders
        DB::table('media')->insert(['name'=>"1", "old_name"=>"1", "extension"=>"jpeg", "mime_type"=>"image/jpeg", "section" => "s", "position" => 1, "path" => "/img/samples/slider/12.jpg", "created_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s'), "updated_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s')]);
        DB::table('media')->insert(['name'=>"2", "old_name"=>"2", "extension"=>"jpeg", "mime_type"=>"image/jpeg", "section" => "s", "position" => 2, "path" => "/img/samples/slider/9.jpg", "created_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s'), "updated_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s')]);
        DB::table('media')->insert(['name'=>"3", "old_name"=>"3", "extension"=>"jpeg", "mime_type"=>"image/jpeg", "section" => "s", "position" => 3, "path" => "/img/samples/slider/10.jpg", "created_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s'), "updated_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s')]);

        // Entities media
        DB::table('media')->insert(['name'=>"icrc", "old_name"=>"icrc.png", "extension"=>"jpeg", "mime_type"=>"image/jpeg", "section" => "par", "position" => 1, "path" => "/img/parties/fmard.jpg", "created_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s'), "updated_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s')]);
        DB::table('media')->insert(['name'=>"health.png", "old_name"=>"health.png", "extension"=>"png", "mime_type"=>"image/png", "section" => "par", "position" => 2, "path" => "/img/parties/health.png", "created_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s'), "updated_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s')]);
        DB::table('media')->insert(['name'=>"environment", "old_name"=>"environment.png", "extension"=>"png", "mime_type"=>"image/png", "section" => "par", "position" => 3, "path" => "/img/parties/environment.png", "created_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s'), "updated_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s')]);
        DB::table('media')->insert(['name'=>"mines_steel", "old_name"=>"mines_steel.png", "extension"=>"jpeg", "mime_type"=>"image/jpeg", "section" => "par", "position" => 4, "path" => "/img/parties/mines_steel.png", "created_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s'), "updated_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s')]);
        DB::table('media')->insert(['name'=>"transportation", "old_name"=>"transportation.png", "extension"=>"png", "mime_type"=>"image/png", "section" => "par", "position" => 5, "path" => "/img/parties/transportation.png", "created_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s'), "updated_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s')]);
        DB::table('media')->insert(['name'=>"waterresources", "old_name"=>"waterresources.png", "extension"=>"png", "mime_type"=>"image/png", "section" => "par", "position" => 6, "path" => "/img/parties/waterresources.png", "created_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s'), "updated_at"=>\Carbon\Carbon::now()->format('Y-m-d H:i:s')]);
