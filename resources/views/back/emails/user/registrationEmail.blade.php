                        ...
                        <table class="content" border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse;border-spacing: 0;width: 100%;">
                            ...
                            <tr>
                                <td class="padded" style="padding: 40px;vertical-align: top;">
                                    ...
                                    <h2 style="margin-top: 0;font-family: 'Roboto Slab', Helvetica, serif;color: #1f91f3;font-size: 1.3em;">{{__("emails.register_title")}} {{env('APP_TITLE')}}</h2>
                                    ...
                                    <p style="margin-top: 0;margin-bottom: 12px;color: #212121;font-family: 'Roboto', Helvetica, sans-serif;font-weight: 400;font-size: 14px;line-height: 20px;">{{__("emails.register_first_text")}}:</p>
                                    <div class="user-information" style="margin-bottom:12px;">
                                       <div>
                                            <p style="margin-top: 0;margin-bottom: 5px;color: #1f91f3;;font-family: 'Roboto', Helvetica, sans-serif;font-weight: 400;font-size: 14px;line-height: 20px;"><b>{{__("emails.register_username")}}</b></p>
                                            <p style="margin-top: 0;margin-bottom: 5px;color: #212121;font-family: 'Roboto', Helvetica, sans-serif;font-weight: 400;font-size: 14px;line-height: 20px;">{{ $email }}
                                        </p></div>
                                        <div>
                                            <p style="margin-top: 0;margin-bottom: 5px;color: #1f91f3;;font-family: 'Roboto', Helvetica, sans-serif;font-weight: 400;font-size: 14px;line-height: 20px;"><b>{{__("emails.register_password")}}</b></p>
                                            <p style="margin-top: 0;margin-bottom: 5px;color: #212121;font-family: 'Roboto', Helvetica, sans-serif;font-weight: 400;font-size: 14px;line-height: 20px;">{{ $password }}</p>
                                        </div>
                                    </div>

                                    <p style="margin-bottom: 0;margin-top: 0;color: #212121;font-family: 'Roboto', Helvetica, sans-serif;font-weight: 400;font-size: 14px;line-height: 20px;"><b>{{__("emails.register_login")}}:</b></p>

                                    <button id="welcome-button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect" style="cursor: pointer;display: inline-block;outline: 0;outline-offset: 0;-webkit-text-size-adjust: none;mso-hide: all;border: 1px solid #1f91f3;border-radius: 2px;line-height: 36px;text-align: center;text-transform: uppercase;width: 200px;height: 36px;background-color: #1f91f3;color: #fff;margin-top: 5px;margin-bottom: 12px;"><a href="{{ url('/login') }}" target="_blank" style="text-decoration: none;color: #fff;">{{__("emails.register_start")}}</a></button>
                                    ...
                                    <p style="margin-bottom: 12px;margin-top: 0;color: #212121;font-family: 'Roboto', Helvetica, sans-serif;font-weight: 400;font-size: 14px;line-height: 20px;">{{route('dashboard')}}</p>
