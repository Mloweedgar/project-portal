        ...
        <div class="container">
            <ul class="docs-nav" id="menu-left">
                ...
                @if (!Auth::user()->isIT() && !Auth::user()->isAuditor())
                    ...
                    <li><a href="#award" class=" ">Award & Financing</a></li>
            ...
            <div class="docs-content">
                ...
                @if (Auth::user()->isAdmin() || Auth::user()->isIT())
                    ...
                    <div class="video-wrapper">
                        <div class="youtube" data-embed="NWRA7vTQPvA">
                    ...
                    <div class="video-wrapper">
                        <div class="youtube" data-embed="Nfc4apE4NtI">
                            <div class="play-button"></div>
                        </div>
                    </div>
                    ...
                    <div class="video-wrapper">
                        <div class="youtube" data-embed="WjKrbg8jQrc">
                            <div class="play-button"></div>
                        </div>
                    </div>
                    ...
                    <div class="video-wrapper">
                        <div class="youtube" data-embed="WhlioWqZZiM">
                            <div class="play-button"></div>
                        </div>
                    </div>
                    <h3 id="graphs"> Graphs</h3>
                    <p>In this page, the user can manage the graphs being displayed on the homepage.</p>
                    <p>There are different graphs available in this section, and the user can decide the order of each of them using the drag & drop system (simply move the graph with the mouse to desired position)</p>
                    ...
                    <div class="video-wrapper">
                        <div class="youtube" data-embed="2y8YBO5HxjE">
                            <div class="play-button"></div>
                        </div>
                    </div>
                @endif
                ...
                @if (!Auth::user()->isIT() && !Auth::user()->isAuditor())
                    ...
                    <div class="video-wrapper">
                        <div class="youtube" data-embed="BAJ4yahVUH0">
                            <div class="play-button"></div>
                        </div>
                    </div>
                    <h4> Filters</h4>
                    ...
                    <div class="video-wrapper">
                        <div class="youtube" data-embed="EIFvJ5r14N0">
                            <div class="play-button"></div>
                        </div>
                    </div>
                    ...
                    <div class="video-wrapper">
                        <div class="youtube" data-embed="oX7IrnmgEUQ">
                            <div class="play-button"></div>
                        </div>
                    </div>
                    ...
                    <div class="video-wrapper">
                        <div class="youtube" data-embed="ttLnbWYWnjQ">
                            <div class="play-button"></div>
                        </div>
                    </div>
                    ...
                    <ul>
                        <li>The “Procurement name” field where the user can add a “Name” for the procurement document to be added. Or the user can select a premade name from the dropdown list. (This field is required)</li>
                        <img src="/img/documentation/{{env('APP_NAME')}}/procurementmenu.jpg" class="responsive-img" />
                    ...
                    <div class="video-wrapper">
                        <div class="youtube" data-embed="12kUWLywn_s">
                            <div class="play-button"></div>
                        </div>
                    </div>
                    ...
                    <div class="video-wrapper">
                        <div class="youtube" data-embed="k6lwL9jUZ0k">
                            <div class="play-button"></div>
                        </div>
                    </div>
                    ...
                    <div class="video-wrapper">
                        <div class="youtube" data-embed="nBNGMarmFKk">
                            <div class="play-button"></div>
                        </div>
                    </div>
                    <h3 id="award">Award & Financing</h3>
                    <p>This page allows the user to add and manage the project Award & Financing.</p>
                    <img src="/img/documentation/{{env('APP_NAME')}}/award1.jpg" class="responsive-img" />
                    <p>There are three sections available on this page:</p>
                    <h4>Award Information</h4>
                    <p>In this section, the user can update the "Award Information" section. The form contains the following fields:</p>
                    <ul>
                        <li>The “Award name” field where the user can add a “Name” for the "Award Information". (This field is required)</li>
                        <li>The “Total value US$ (million)” field where the user can submit the total value of the "Award". (This field is required)</li>
                        <li>The "Award Status" field, where the user can select the status. (Optional field)</li>
                        <li>The "Award date" field, where the user can select the date of the award. (Optional field)</li>
                        <li>The "Award Status" field, where the user can select the status. (Optional field)</li>
                        <li>The "Contract signature date start" field, where the user can update the date of the start of the contract signature. (Optional field)</li>
                        <li>The "Contract signature date end" field, where the user can update the date of the end of the contract signature. (Optional field)</li>
                        <li>The "Description" field, where the user can update the description of the award. (Optional field)</li>
                    </ul>
                    <p>When all the required fields are filled, the user can save all the information by clicking on the “Publish” button.</p>
                    <h4>Preferred Bidder</h4>
                    <p>In this section, the user can click to manage the "Preferred Bidders".</p>
                    <img src="/img/documentation/{{env('APP_NAME')}}/award2.jpg" class="responsive-img" />
                    <ul>
                        <li>To add a “Preferred Bidder”, the user must select the entity and click on the “Publish” button.</li>
                        <li>To delete a “Preferred Bidder”, the user must click on the delete button on the header of the "Preferred Bidder" box.</li>
                    </ul>
                    <h4>Financing Information</h4>
                    <p>In this section, the user can click to manage the "Financing Information".</p>
                    <img src="/img/documentation/{{env('APP_NAME')}}/award3.jpg" class="responsive-img" />
                    <ul>
                        <li>To add a “Financing Information”, the user must fill the fields on the form and click on the “Publish” button.</li>
                        <li>To update a “Financing Information”, the user must click on the header of the "Financing Information" box, fill the fields on the form and click on the "Publish" button.</li>
                        <li>To delete a “Financing Information”, the user must click on the delete button on the header of the "Financing Information" box.</li>
                    </ul>
                    ...
                    <div class="video-wrapper">
                        <div class="youtube" data-embed="d7h3ub41c2Q">
                            <div class="play-button"></div>
                        </div>
                    </div>
                ...
                @if (Auth::user()->isAdmin())
                    ...
                    <div class="video-wrapper">
                        <div class="youtube" data-embed="oCly5XBejgk">
                            <div class="play-button"></div>
                        </div>
                    </div>
                    <h4>Edit role</h4>
                ...
                @if (Auth::user()->isAdmin() || Auth::user()->isIT())
                    ...
                    <div class="video-wrapper">
                        <div class="youtube" data-embed="SMwPRzRKAaE">
                            <div class="play-button"></div>
                        </div>
                    </div>
                    ...
                    <h4>Publisher, License and Publication Policy</h4>
                    <p>This section allows the Administrator of the PPP Unit to include all the relevant information required to comply with the OCDS standard including:</p>
                    <ul>
                        <li>Publisher name</li>
                        <li>Publisher scheme</li>
                        <li>Publisher id</li>
                        <li>Publisher uri</li>
                        <li>License document</li>
                        <li>Publication policy document</li>
                    </ul>
                    <img src="/img/documentation/{{env('APP_NAME')}}/conf11.jpg" class="responsive-img" />
                    <div class="video-wrapper">
                    ...
                    @if (Auth::user()->isAdmin())
                        ...
                        <div class="video-wrapper">
                            <div class="youtube" data-embed="pk126Hb3GD8">
                                <div class="play-button"></div>
                            </div>
                        </div>
                    @endif
                ...
                @if (!Auth::user()->isIT() && !Auth::user()->isAuditor())
                    ...
                    <div class="video-wrapper">
                        <div class="youtube" data-embed="P90mxsFAX7A">
                            <div class="play-button"></div>
                        </div>
                    </div>
                    @if (!Auth::user()->isDataEntry() && !Auth::user()->isProjectCoordinator())
                        ...
                        <div class="video-wrapper">
                            <div class="youtube" data-embed="q-2-cHhOiH8">
                                <div class="play-button"></div>
                            </div>
                        </div>
                        ...
                        <div class="video-wrapper">
                            <div class="youtube" data-embed="A3S31f9ZMZM">
                                <div class="play-button"></div>
                            </div>
                        </div>
                        ...
                        <div class="video-wrapper">
                            <div class="youtube" data-embed="v5acDnUkz9o">
                                <div class="play-button"></div>
                            </div>
                        </div>
                    @endif
                ...
                @if (!Auth::user()->isIT() && !Auth::user()->isAuditor())
                    ...
                    <p>Note: in projects subsections (for example Financial Structure inside Contract summary), the first switch controls the visibility of the whole main section (in this case Contract summary) and the second switch controls the visibility of the section the user is in (in this case Financial Structure).</p>
                    <img src="/img/documentation/{{env('APP_NAME')}}/gen4.jpg" class="responsive-img" />
                    <div class="video-wrapper">
                        <div class="youtube" data-embed="rkaUiaPGpMM">
                            <div class="play-button"></div>
                        </div>
                    </div>
                @endif
                @if (!Auth::user()->isAuditor())
                    ...
                    <div class="video-wrapper">
                        <div class="youtube" data-embed="t-JyNmAE_uy6o">
                            <div class="play-button"></div>
                        </div>
                    </div>
                @endif
                ...
                @if (!Auth::user()->isAuditor() && !Auth::user()->isIT() && !Auth::user()->isViewOnly())
                    ...
                    <ul>
                        ...
                        <li>Redacted PPP agreement</li>
                        <li>Award & Financing</li>
...
@section('scripts')
    ...
    <script>
        ...
        $(".docs-nav").on('click','a',function () {

            var sectionID = $(this).attr('href');
            $([document.documentElement, document.body]).animate({
                scrollTop: $(sectionID).offset().top-$("nav.navbar").innerHeight()
            }, 2000);
        });

        $(document).ready(function () {

            $(".docs-nav").css("height",'calc(100vh - 200px)');
