...
@section('content')
    <div id="basic-info" class="hidden-xs hidden-sm" style="background: url({{$projectBG}});">
        <div class="container">
            ...
            <div class="row">
                <div class="basic-info-box col-md-4">
                    <div class="inner">
                        ...
                        @if($project->projectInformation && isset($project->projectInformation))
            ...
            <div class="row"-->
                ...
                <div  class="basic-info-box col-md-4">
                    <div class="inner">
                        <h2>{{trans('general.proposed_form_of_contract')}}</h2>
                        <p>@if(!isset($project->projectInformation->ppp_delivery_model->name)) Not specified @else {{$project->projectInformation->ppp_delivery_model->name}} @endif</p>
                    </div>
                </div>
                ...
                @if($project->projectInformation->indicative_timing_invest != '')
                <div class="basic-info-box col-md-4">
                    <div class="inner">
                        <h2>
                          {{trans('general.timing_invest')}}
                        </h2>
                        <p>
                        {{$project->projectInformation->indicative_timing_invest}}
                        </p>
                    </div>
                </div>
                @endif
    ...
    <div id="project-m" class="visible-sm-block visible-xs-block">
        ...
        <div id="project-info-m" class="row">
            ...
            <div class="col-md-4 col-xs-6">
                <h2>{{trans('general.timing_invest')}}</h2>
                <p>{{$project->projectInformation->indicative_timing_invest}}</p>
            </div>
        </div>
    </div>
                    ...
                    <div id="project-info" class="project-info"> <!-- project-info -->
                        ...
                        @if ($project->projectInformation)
                            <ul>
                                ...
                                <li>
                                    <h3>{{trans('project/project-information.prefeasibility_study_report')}}</h3>
