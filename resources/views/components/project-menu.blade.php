    ...
    <div class="project-submenu">
        <ul>
            @if (Request::is('project/*/contract-information/*'))
                ...
                @if (Auth::user()->canAccessPDAward($project))
                    <li class="{{active('project/*/contract-information/award')}}"><a href="{{route('project-details-award', array('id' => $project->id))}}">{{__("project.section.project_details.award")}}</a></li>
                @endif
