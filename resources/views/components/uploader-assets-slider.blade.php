...
<script>
    ...
    $.each($('.fine-uploader'), function(index, object){
        ...
        loadFineUploaderEdition($(this),object, projectAddress, sectionAddress, positionAddress, uniqueToken);
     ...
     * @param uniqueToken
     */
    function loadFineUploaderDynamic(div,element, project, section, position, uniqueToken){
     ...
     * @param uniqueToken
     */
    function loadFineUploaderEdition(div,element, project, section, position, uniqueToken){
        ...
        var uploader = new qq.FineUploader({
            ...
            callbacks: {
                onComplete: function () {
                    $(div).closest('.upload-component').find(".js-gallery").addClass("disabled").removeClass('enabled');
                }
            },
            session: {
